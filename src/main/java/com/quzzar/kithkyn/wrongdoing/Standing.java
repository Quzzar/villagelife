...
public final class Standing {
  ...
  public static Tier tierFor(int standing) {
    if (standing <= com.quzzar.kithkyn.configuration.KithkynConfig.StandingHostileBelow) {
      return Tier.HOSTILE;
    }
    if (standing <= com.quzzar.kithkyn.configuration.KithkynConfig.StandingShunnedBelow) {
      return Tier.SHUNNED;
    }
    if (standing <= com.quzzar.kithkyn.configuration.KithkynConfig.StandingUnwelcomeBelow) {
      return Tier.UNWELCOME;
    }
    if (standing <= com.quzzar.kithkyn.configuration.KithkynConfig.StandingDislikedBelow) {
      return Tier.DISLIKED;
    }
    return standing >= com.quzzar.kithkyn.configuration.KithkynConfig.StandingTrustedAbove
        ? Tier.TRUSTED
        : Tier.NEUTRAL;
  }
  ...
  public static double priceMultiplier(int standing) {
    ...
    double depth = com.quzzar.kithkyn.configuration.KithkynConfig.StandingDislikedBelow - standing;
    double span = Math.max(1.0D,
        com.quzzar.kithkyn.configuration.KithkynConfig.StandingDislikedBelow
            - com.quzzar.kithkyn.configuration.KithkynConfig.StandingUnwelcomeBelow);
    double worst = com.quzzar.kithkyn.configuration.KithkynConfig.StandingWorstMarkup;
