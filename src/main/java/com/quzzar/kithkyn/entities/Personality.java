...
import com.quzzar.kithkyn.utils.WeightedCollection;
...
public enum Personality {
    ...
    /**
     * Prompt-safe wording. STOUT means stout-hearted; passing the bare enum
     * word to an LLM produced villagers described as physically stout.
     */
    public String displayName() {
        return this == STOUT ? "stout-hearted" : name().toLowerCase(java.util.Locale.ROOT);
    }
