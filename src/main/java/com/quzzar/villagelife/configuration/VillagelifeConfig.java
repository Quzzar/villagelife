...
public class VillagelifeConfig {
    ...
    public static class CommonConfig {
        ...
        public CommonConfig(ModConfigSpec.Builder builder) {
            ...
            LlmLocalModel = builder.comment("Which model the 'llamacpp' provider downloads and runs (unused by every other provider): 'qwen-3b' (default), 'llama-3b', 'gemma-2-2b' or 'qwen-1.5b'. The default was picked by benchmarking all four on the jobs the mod actually gives them. The smaller two answer faster and are more likely to pick a poor action or drop a villager's traits. Each is a one-time download of 1 to 2 GB.").translation(Villagelife.MODID + ".config.LlmLocalModel").define("LLM local model", "qwen-3b");
