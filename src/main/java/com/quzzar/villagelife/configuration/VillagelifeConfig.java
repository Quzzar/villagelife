...
public class VillagelifeConfig {
    ...
    public static class CommonConfig {
        ...
        public CommonConfig(ModConfigSpec.Builder builder) {
            ...
            LlmLocalModel = builder.comment("Which model the 'llamacpp' provider downloads and runs (unused by every other provider): 'gemma-2-2b', 'qwen-3b', 'qwen-1.5b', 'llama-3b' or 'phi-3.5'. Larger models answer better and slower, and each is a one-time download of 1 to 2.5 GB.").translation(Villagelife.MODID + ".config.LlmLocalModel").define("LLM local model", "gemma-2-2b");
