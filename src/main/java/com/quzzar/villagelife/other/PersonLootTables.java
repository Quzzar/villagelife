...
public class PersonLootTables {
    ...
    private static ResourceKey<LootTable> key(String path) {
        return ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(Villagelife.MODID, path));
    }
    ...
    public static LootContextParamSet register(String name, Consumer<LootContextParamSet.Builder> consumer) {
        ...
        ResourceLocation resourcelocation = ResourceLocation.fromNamespaceAndPath(Villagelife.MODID, name);
