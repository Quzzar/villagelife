...
public final class LlmCallLog {
  ...
  private static final String LOGGER_NAME = "villagelife.llm";
  private static final String APPENDER_NAME = "VillagelifeLlmCalls";
  ...
  public static synchronized void install() {
    ...
    try {
      ...
      installed = true;
      Villagelife.LOGGER.info("LLM calls are recorded in full in {}", FILE);
      ...
      // the server with it.
      Villagelife.LOGGER.warn("Could not open {}; LLM calls will be recorded at debug level in the main log instead",
          FILE, failure);
    }
  }
